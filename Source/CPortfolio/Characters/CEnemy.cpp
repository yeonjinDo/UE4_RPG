...
void ACEnemy::BeginPlay()
{
	...
	SubState->OnSubStateTypeChanged.AddDynamic(this, &ACEnemy::OnSubStateTypeChanged);
...
void ACEnemy::Landed(const FHitResult& HitResult)
{
